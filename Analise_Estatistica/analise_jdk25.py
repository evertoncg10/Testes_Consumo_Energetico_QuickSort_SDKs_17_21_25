...
def executar_analise():
    print("=" * 60)
    print("ANÁLISE ESTATÍSTICA INDIVIDUAL: JDK 25")
    print("=" * 60)
    ...
    arquivo_xlsx = os.path.join(dados_dir, "Planilha_Dados_das_Execuções_JDK_25-0-2.xlsx")
    output_grafico = r"c:\Users\evert\Documents\0-Testes_Software_Verde\Testes_Versões_JDK_17_21_25\Testes_Consumo_Energetico_QuickSort_SDKs_17_21_25\Analise_Estatistica\resultados\graficos\distribuicoes_densidade_qq_jdk25.png"
    ...
    dist_fits = utils.ajustar_e_plotar_distribucoes(df, 'Energia (J)', 'JDK 25', output_grafico)
